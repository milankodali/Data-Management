...
DROP TABLE SIM_Contributions CASCADE CONSTRAINTS ;
...
CREATE TABLE SIM_Contributions
  (
    SIM_Person_person_id   INTEGER NOT NULL ,
    SIM_project_project_id INTEGER NOT NULL ,
    contribution_id        INTEGER NOT NULL
  ) ;
ALTER TABLE SIM_Contributions ADD CONSTRAINT SIM_Contributions_PK PRIMARY KEY ( contribution_id ) ;
...
ALTER TABLE SIM_Contributions ADD CONSTRAINT SIM_Cont_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_Contributions ADD CONSTRAINT SIM_Cont_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
